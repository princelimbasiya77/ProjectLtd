...
if(@$_GET['searchClick'])
    {
        ...
        $query = "SELECT * FROM `admission` WHERE `Name` LIKE '%$search_value%'";

    }
else
    {

    $query = "SELECT * FROM `admission` WHERE `status` = '0' ";
    ...
    if(@$_GET['delete'])
    {
        ...
        $qry = "UPDATE `admission` SET `status`='1' WHERE `id`= $delete_id";
                    ...
                    ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><button type="button" class="btn btn-block btn-outline-warning"><a
                                                    href="editAdmission.php?edit=<?php echo $row['id'];?>">Edit</a></button>
                                        </td>

                                        <td>
                                            <button type="button" class="btn btn-block btn-outline-danger"><a
                                                    href="viewAdmission.php?delete=<?php echo $row['id'];?>">Delete</a></button>
