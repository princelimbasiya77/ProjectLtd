...
if(@$_GET['searchClick'])
    {
        ...
        $query = "SELECT * FROM `course` WHERE `name` LIKE '%$search_value%'";
    ...
    if(@$_GET['delete'])
    {
        ...
        $qry = "UPDATE `course` SET `status`='1' WHERE `id`= $delete_id";
                  ...
                  while($row = mysqli_fetch_assoc($res))
                  {
                    ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="courseimg/<?php echo $row['img']; ?>" alt="" width="100px"
                                                height="100px"></td>
                                        <td><button type="button" class="btn btn-block btn-outline-warning"><a
                                                    href="editcourse.php?edit=<?php echo $row['id'];?>">Edit</a></button>
                                        </td>

                                        <td>
                                            <button type="button" class="btn btn-block btn-outline-danger"><a
                                                    href="viewcourse.php?delete=<?php echo $row['id'];?>">Delete</a></button>
