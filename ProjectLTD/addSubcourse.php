...
if(isset($_POST['addsubCourse']))
    {
        ...
        move_uploaded_file($_FILES['cimg']['tmp_name'],"subimg/".$img);
        $qry = "INSERT INTO `subcourse` (`name`,`title`,`link`,`img`,`courseid`) VALUES ('$name','$title','$link','$img','$courseID')";
        ...
        <div class="w-100">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                ?>
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">ADD SUBCOURSE NAME</label>
                        <input type="text" name="cname" class="form-control" id="exampleInputEmail1"
                            placeholder="ENTER COURSE NAME">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">ADD SUBCOURSE TITLE</label>
                        <input type="text" name="ctitle" class="form-control" id="exampleInputEmail1"
                            placeholder="ENTER COURSE TITLE">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">ADD SUBCOURSE LINK</label>
                        <input type="text" name="clink" class="form-control" id="exampleInputPassword1"
                            placeholder="COURSE LINK">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">ADD SUBCOURSE Img</label>
                ...
                <div class="card-footer">
                    <button type="submit" name="addsubCourse" class="btn btn-primary">ADD SUBCOURSE</button>
                </div>
            </form>
        </div>
        <!-- /.card -->
