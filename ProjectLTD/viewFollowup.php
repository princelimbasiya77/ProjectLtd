...
if(@$_GET['searchClick'])
    {
        ...
        $query = "SELECT * FROM `followup` WHERE `name` LIKE '%$search_value%'";

    }
else
    {

    $query = "SELECT * FROM `followup` WHERE `statusid` = '0' ";
    ...
    if(@$_GET['delete'])
    {
        ...
        $qry = "UPDATE `followup` SET `statusid`='1' WHERE `id`= $delete_id";
...

                  {
                    ?>
                                    <tr>
                                        ...
                                        <td><?php echo $row['inquiryby']; ?></td>
                                        <td><?php echo $row['followupreason']; ?></td>
                                        <td><?php echo $row['joindate']; ?></td>
                                        <td><?php echo $row['followupby']; ?></td>


                                        <td><button type="button" class="btn btn-block btn-outline-warning"><a
                                                    href="editFollowup.php?edit=<?php echo $row['id'];?>">Edit</a></button>
                                        </td>
                                        
                                        <td>
                                            <button type="button" class="btn btn-block btn-outline-danger"><a
                                                    href="viewFollowup.php?delete=<?php echo $row['id'];?>">Delete</a></button>
                                        </td>
