...
if(@$_GET['searchClick'])
    {
        ...
        $query = "SELECT * FROM `inquiry` WHERE `Name` LIKE '%$search_value%'";

    }
else
    {

    $query = "SELECT * FROM `inquiry` WHERE `statusid` = '0' ";
    ...
    if(@$_GET['delete'])
    {
        ...
        $qry = "UPDATE `inquiry` SET `statusid`='1' WHERE `id`= $delete_id";
...

                  {
                    ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['CourseContact']; ?></td>
                                        <td><?php echo $row['CourseFees']; ?></td>
                                        <td><?php echo $row['Reference']; ?></td>
                                        <td><?php echo $row['ReferenceName']; ?></td>
                                        <td><?php echo $row['EnquiryBy']; ?></td>
                                        <td><?php echo $row['AddedBY']; ?></td>
                                        <td><?php echo $row['JoinDate']; ?></td>
                                        <td><?php echo $row['BatchTime']; ?></td>
                                        <td><?php echo $row['Status']; ?></td>
                                        <td><?php echo $row['FollowupDetails']; ?></td>
                                        <td><?php echo $row['EnquiryDetails']; ?></td>


                                        <td><button type="button" class="btn btn-block btn-outline-warning"><a
                                                    href="editInquiry.php?edit=<?php echo $row['id'];?>">Edit</a></button>
                                        </td>
                                        <td><button type="button" class="btn btn-block btn-outline-warning"><a
                                                    href="addFollowup.php?followup=<?php echo $row['id'];?>">FollowUP</a></button>
                                        </td>

                                        <td>
                                            <button type="button" class="btn btn-block btn-outline-danger"><a
                                                    href="viewInquiry.php?delete=<?php echo $row['id'];?>">Delete</a></button>
