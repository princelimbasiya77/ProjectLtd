...
if(@$_GET['edit'])
    {
        $edit_id = $_GET['edit'];
        $qry = "SELECT * FROM `followup` WHERE `id`='$edit_id'";
        $res = mysqli_query($con , $qry);
        $row = mysqli_fetch_assoc($res);
        $Name = $row['name'];
        $ContactNumber = $row['contact'];
        $CourseName = $row['course'];    
        $EnquiryBy = $row['inquiryby'];    
        $FollowupDetails = $row['followupreason'];    
        $JoinDate = $row['joindate'];    
        $AddedBY = $row['followupby']; 
    }
    if(isset($_POST['addFollowup']))
    {
        ...
        if(@$_GET['edit'])
        {
            ...
            $qry = "UPDATE `followup` SET `followupreason`='$FollowupDetails',`joindate`='$JoinDate', `followupby`='$AddedBY' WHERE `id`='$edit_id'";
        }
        else
        {
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="FollowupDetails" rows="3"
                         placeholder="Enter Followup Reason"><?php echo $FollowupDetails; ?></textarea>
                    </div>
                    <!-- 6 -->  
                        <div class="form-group">
                            ...
                            value="<?php echo $JoinDate; ?>"   style="width: 100%;">
                        </div>
                        <div class="form-group">
                            ...
                            <select name="AddedBY" class="form-control select2" style="width:100%;">
                                ...
                                <option value="khushiMam"  <?php if(@$AddedBY == 'khushiMam') { echo "selected"; } ?>>khushi Mam</option>
                                <option value="PrinceSir"  <?php if(@$AddedBY == 'PrinceSir') { echo "selected"; } ?>>Prince Sir</option>
                                <option value="ShivangiMam"  <?php if(@$AddedBY == 'ShivangiMam') { echo "selected"; } ?>>Shivangi Mam</option>
                                <option value="VishalSir"  <?php if(@$AddedBY == 'VishalSir') { echo "selected"; } ?>>Vishal Sir</option>
                                <option value="UtsavSir"  <?php if(@$AddedBY == 'UtsavSir') { echo "selected"; } ?>>Utsav Sir</option>
                            </select>
                        </div>
                        <!-- 5 -->
                    <!-- /.card-body -->
